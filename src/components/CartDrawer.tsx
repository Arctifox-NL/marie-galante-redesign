...
export function CartDrawer({ tone = "light" }: { tone?: "light" | "dark" }) {
    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        ...
        >
          ...
          {totalItems > 0 && (
            <Badge className="absolute -top-1 -right-1 h-5 w-5 rounded-full p-0 text-[10px] bg-accent text-accent-foreground">
              {totalItems}
            </Badge>
          )}
        </button>
